...
public class CardFactory {
    ...
    /**
     * Simplified factory method with minimal parameters
     */
    public Card createBasicCard(String type, String name) {
        return createCard(type, 0, name, "COMMON", 3, 1, 100, 50, 2, 30);
    }
}